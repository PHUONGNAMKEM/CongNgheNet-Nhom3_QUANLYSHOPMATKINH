...
--Thêm
go
create proc THEM_CHITIETHOADON @MAHD CHAR(20), @MAHG CHAR(20), @SL INT, @GIABAN FLOAT
as
	begin
...
--Xóa
go
create proc XOA_CHITIETHOADON @MAHD CHAR(20), @MAHG CHAR(20)
as
	begin
...
--Sửa
go
create proc SUA_CHITIETHOADON @MAHD CHAR(20), @MAHG CHAR(20), @SL INT, @GIABAN FLOAT, @MAHD_TAM CHAR(20), @MAHG_TAM CHAR(20)
as
	begin
...
ALTER PROC EXPORT_FROM_ANY_TABLE @TABLE_NAME CHAR(50)
AS
BEGIN
...
SELECT * FROM THONGTINNHANVIEN
GO
CREATE PROC INSERT_THONGTINNHANVIEN @MANV CHAR(10), @NGAYSINH DATE, @GIOITINH NVARCHAR(5), @CMND CHAR(10), @EMAIL CHAR(30)
AS
BEGIN
...
CREATE PROC DELETE_THONGTINNHANVIEN @MANV CHAR(10)
AS
BEGIN
...
CREATE PROC UPDATE_THONGTINNHANVIEN @MANV_OLD CHAR(10), @MANV_NEW CHAR(10), @NGAYSINH DATE, @GIOITINH NVARCHAR(5), @CMND CHAR(10), @EMAIL CHAR(30)
AS
BEGIN
	SET DATEFORMAT DMY;
...
--Thêm
go
create proc THEM_CHITIETPN(@MAPN char(20), @MAHG char(20), @SOLUONG int, @GIABAN float)
as
	begin
...
go
--Xóa
create proc XOA_CHITIETPN(@MAPN CHAR(20), @MAHG CHAR(20))
as
	begin
...
--Sửa
go
create proc SUA_CHITIETPN(@MAPN char(20),@MAHG char(20),@SOLUONG int,@GIABAN float,@MAPN_TAM char(20),@MAHG_TAM char(20))
as
	begin
...
SET DATEFORMAT DMY
go
create proc THEM_PHIEUNHAP(@MAPN char(20), @NGAYNHAP date, @MANCC char(20), @MANV char(20))
as
	begin
...
go
--Xóa
create proc XOA_PHIEUNHAP(@MAPN CHAR(20))
as
	begin
...
SET DATEFORMAT DMY
go
create proc SUA_PHIEUNHAP(@MAPN char(20), @NGAYNHAP date, @MANCC char(20), @MANV char(20), @MAPN_TAM CHAR(20))
as
	begin
		UPDATE PHIEUNHAP SET MAPN = @MAPN, NGAYNHAP = @NGAYNHAP, MANCC = @MANCC, MANV = @MANV WHERE MAPN = @MAPN_TAM
	end
go
...
SET DATEFORMAT DMY
go
create proc THEM_NHACC(@MAPN char(20), @TENNCC nvarchar(30), @DIACHI nvarchar(20), @SODT char(20))
as
	begin
		INSERT INTO NHACC(MANCC, TENNCC, DIACHI, SODT) VALUES(@MAPN, @TENNCC, @DIACHI, @SODT)
	end
go
EXEC THEM_NHACC 'NCC003', N'Công ty C', N'Cà Mau', '0922345678'
go
--Xóa
create proc XOA_NHACC(@MANCC CHAR(20))
as
	begin
...
SET DATEFORMAT DMY
go
create proc SUA_NHACC(@MANCC char(20), @TENNCC nvarchar(30), @DIACHI nvarchar(30), @SODT char(20), @MANCC_TAM char(20))
as
	begin
		UPDATE NHACC SET MANCC = @MANCC, TENNCC = @TENNCC, DIACHI = @DIACHI, SODT = @SODT WHERE MANCC = @MANCC_TAM
	end
go
...
SET DATEFORMAT DMY
go
create proc THEM_LOAIHANG(@MALOAI char(20), @TENLOAI nvarchar(30))
as
	begin
		INSERT INTO LOAIHANG(MALOAI, TENLOAI) VALUES(@MALOAI,@TENLOAI)
	end
go
EXEC THEM_LOAIHANG 'LT005', N'Kính răm'
go
--Xóa
create proc XOA_LOAIHANG(@MALOAI CHAR(20))
as
	begin
...
SET DATEFORMAT DMY
go
create proc SUA_LOAIHANG(@MALOAI char(20), @TENLOAI nvarchar(30),@MALOAI_TAM char(20))
as
	begin
		UPDATE LOAIHANG SET MALOAI = @MALOAI, TENLOAI = @TENLOAI WHERE MALOAI = @MALOAI_TAM
	end
go
